...
Spark01 LLM (qwen3.8-flash-next) rewrites the prompt H3 actually receives into the
official Context-IR layout. Optional spark01 VLM (same model) adds retention
