...
const faqs = [
  {
    question: "DashBox 和普通 AI 视频生成工具有什么区别？",
    answer:
      "普通工具通常围绕一次提示词、一个片段或一张图工作。DashBox 面向的是完整项目：从文本导入、资产沉淀、剧集规划、镜头制作到合成导出，形成可追踪、可协作、可复用的生产闭环。",
  },
  {
  ...
  },
  {
    ...
    answer:
      "DC 源自 Drama & Creation，也代表每个创作者自己的内容宇宙。DashBox 希望帮助创作者从一个故事开始，逐步建立角色、世界观、场景资产和系列化内容生产能力。",
  },
  {
    question: "登录后我会进入哪里？",
    answer:
