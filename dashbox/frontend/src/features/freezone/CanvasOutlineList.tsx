...
const NODE_TYPE_ICON: Record<CanvasNodeType, LucideIcon> = {
  ...
  [CANVAS_NODE_TYPES.nsfwImageGen]: Flame,
  [CANVAS_NODE_TYPES.nsfwVideoGen]: Clapperboard,
  [CANVAS_NODE_TYPES.nsfwScript]: Flame,
...
export const CANVAS_OUTLINE_FILTERS: ReadonlyArray<{
  ...
  { key: "audio", types: [CANVAS_NODE_TYPES.audio, CANVAS_NODE_TYPES.nsfwFactoryAudio] },
  {
    key: "script",
    types: [
