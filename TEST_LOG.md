...
- 2026-09-03 workstation :8195 ComfyUI 0.30.0→0.34.0 (via 设备管家): git a87667f includes #15439. Native MiniMaxH3AddGuide present; ImageToVideo/ReferenceToVideo still present. P4 repair-502 node gap closed (fail-closed remains if node missing). INT8/Turbo not re-downloaded. Did not SSH spark02. Cluster SoT is ../ToIV/AGENTS.md. LICENSE/NOTICE untouched.
